...
int8_t LLCP::waitForConnection(uint16_t timeout)
{
    ...
    // Put CC PDU
    DMSG("\r\n4:put a CC(Connection Complete) PDU to response the CONNECT PDU");
