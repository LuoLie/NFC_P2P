...
static void xprintchar(char **str, int c)
{
...
static int xprints(char **out, const char *string, int width, int pad)
{
...
static int xprinti(char **out, int i, int b, int sg, int width, int pad, int letbase)
{
...
static int xprint( char **out, const char *format, va_list args )
{
...
int xsnprintf( char *buf, unsigned int count, const char *format, ... )
{
        va_list args;
